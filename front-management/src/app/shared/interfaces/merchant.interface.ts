...
export function mapMerchantOperationalStatus(
  ...
  const statusMap: Record<string, MERCHANT_OPERATIONAL_STATUS> = {
    ...
    [OPERATIONAL_STATUS.INACTIVE]: OPERATIONAL_STATUS.INACTIVE,
    [OPERATIONAL_STATUS.SUSPENDED]: OPERATIONAL_STATUS.SUSPENDED,
    [OPERATIONAL_STATUS.LOCKED]: OPERATIONAL_STATUS.LOCKED,
  };
  return statusMap[status] ?? OPERATIONAL_STATUS.INACTIVE;
}
